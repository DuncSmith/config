alias pub='git push -u origin HEAD && gh pr create --web'
alias cap='git pull --rebase origin master'
alias odcap='OVERCOMMIT_DISABLE=1 cap'
alias gap='git add -N . && git add -p'
alias gtags='ripper-tags --tag-file=.tags --recursive --force --exclude=/assets/ --exclude=.bundle --exclude=.git/ --exclude=coverage/ --exclude=log/ --exclude=tmp/ --exclude=bin/'
alias mygems='gem install $(cat ~/.default_gems)'
alias be='bundle exec'
alias devvars='eval "$(devkit --no-version-check env vars)"'
alias ls='exa'
...
# alias save-config='config add -u && config commit -m 'update' && config push'
# alias save-brew='brew bundle dump --force && config add Brewfile && save-config'
